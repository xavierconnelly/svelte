...
Using template from [Sapper](https://github.com/sveltejs/sapper).


## Getting started

Can use either Rollup or webpack as bundler.
...
```bash
git remote add origin https://github.com/xavierconnelly/basil.git
git branch -M main
